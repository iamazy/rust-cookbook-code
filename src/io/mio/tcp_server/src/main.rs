...
fn main() -> io::Result<()> {
    ...
    let mut uniqut_token = Token(SERVER.0 + 1);

    println!("You can connect to the server using `nc`:");
    println!("$ nc 127.0.0.1 9000");
    println!("You will see our welcome message and anything you type we'll be printed here.");
                ...
                SERVER => loop {
                    ...
                    let (mut connection, address) = match server.accept() {
                        ...
                        Err(e) if e.kind() == io::ErrorKind::WouldBlock => {
                            ...
                            // has no more incoming connections queued, so we can return to polling
                    ...
                    let token = next(&mut uniqut_token);
...
fn handle_connection_event(
    ...
    if event.is_writable() {
        ...
        match connection.write(DATA) {
            ...
            // less we'll return a short write error (same as `io::Write::write_all` does).
    ...
    if event.is_readable() {
        ...
        loop {
            ...
            match connection.read(&mut buf) {
                ...
                // actually ready to perform this I/O operation
