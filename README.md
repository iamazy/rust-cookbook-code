...
[clepsydra](https://github.com/graydon/clepsydra) -> [**Ocean Vista: Gossip-Based Visibility Control for Speedy Geo-Distributed Transactions**, **Distributed SQL database**] 